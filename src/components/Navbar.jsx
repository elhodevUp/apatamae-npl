          ...
          <nav className="hidden md:flex items-center gap-1 bg-[#edeeef]/70 backdrop-blur-md p-1.5 rounded-full border border-white/60 shadow-inner">
            {navLinks.map((link) => (
              <NavLink
                ...
                to={link.path}
                className={({ isActive }) =>
                  `px-4 py-2 rounded-full text-xs font-semibold tracking-wide transition-all ${isActive
          ...
          <div className="flex flex-col gap-2">
            {navLinks.map((link) => (
              <NavLink
                ...
                className={({ isActive }) =>
                  `text-left px-4 py-3 rounded-xl text-sm font-semibold transition-colors ${isActive
