                ...
                {heroSlides.map((_, i) => (
                  <button
                    ...
                    className={`h-2.5 rounded-full transition-all duration-500 ${
                      currentSlide === i ? 'bg-[#1B4332] w-8' : 'bg-[#0A2540]/30 w-2.5'
                    }`}
                  />
                ))}
              </div>
        ...
        <div className="max-w-7xl mx-auto space-y-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="glass-panel p-8 rounded-[40px] bg-white/90 border border-white/80 shadow-xl hover:-translate-y-2 transition-all duration-300 group space-y-6 flex flex-col justify-between">
              ...
              <Link to="/nos-programmes" className="inline-flex items-center text-xs font-extrabold text-[#1B4332] gap-2 hover:gap-3 transition-all">
            ...
            <div className="glass-panel p-8 rounded-[40px] bg-white/90 border border-white/80 shadow-xl hover:-translate-y-2 transition-all duration-300 group space-y-6 flex flex-col justify-between">
              ...
              <Link to="/nos-programmes" className="inline-flex items-center text-xs font-extrabold text-[#0A2540] gap-2 hover:gap-3 transition-all">
